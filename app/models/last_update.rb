class LastUpdate < ActiveRecord::Base
  ...
  attr_accessible :email, :firstname, :lastname, :phone_number, :mobile_number, :profile_id, :published, :social_status_id, :trading_identifier, :company_name, :created_by, :sector_id, :sales_area_id, :comment, :new_email, :new_firstname, :new_lastname, :new_phone_number, :new_mobile_number, :new_profile_id, :new_published, :new_social_status_id, :new_trading_identifier, :new_company_name, :new_created_by, :new_sector_id, :new_sales_area_id, :new_comment, :created_at, :user_id, :update_type_id
