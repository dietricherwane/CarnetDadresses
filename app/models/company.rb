class Company < ActiveRecord::Base
  ...
  attr_accessible :email, :phone_number, :published, :social_status_id, :trading_identifier, :name, :created_by, :sector_id, :sales_area_id, :geographical_address, :postal_address, :city, :country_id, :shortcut, :capital, :employees_amount, :turnover, :holding_id, :activities, :fax, :website, :logo, :created_by, :validated_by
